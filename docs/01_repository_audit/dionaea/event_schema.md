# DIONAEA - Event Schema
> **Status:** `WORKING` | **Suite:** Distributed Honeypot Benchmark Framework (Team Gamergenix, PCCOE)

## Overview
Audit specification for dionaea analyzing event_schema.md.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **DIONAEA - Event Schema** within the Distributed Honeypot Benchmark Framework.
