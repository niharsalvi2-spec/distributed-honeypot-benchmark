...
## Overview
Paired t-tests, Mann-Whitney U tests, effect size (Cohen's d) calculations.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **Statistical Methodology** within the Distributed Honeypot Benchmark Framework.

## 2. Technical Specifications
- **Component ID:** statistical_methodology
