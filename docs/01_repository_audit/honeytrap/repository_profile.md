# Honeytrap Repository Profile
> **Repository:** `honeytrap` | **Tier:** Secondary | **Evidence Level:** Level 2 (Source-Code Verified)
...
| :--- | :--- | :--- |
| **Level 1: Documentation** | `CLAIMED` | Dynamic port honeypot in Go. |
| **Level 2: Source Verification** | `VERIFIED` | Verified 318 source files in pkg/. |
...
Modular channels and listeners without cross-node causal ordering.
