# E01: Functional Validation and Parsing Completeness

## Overview
Validates schema adherence, field normalization completeness, and parser accuracy across all 7 audited honeypots.
...
```bash
python experiments/E01_functional/runner.py
```
