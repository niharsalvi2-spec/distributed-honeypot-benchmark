...
## Overview
Audit specification for conpot analyzing event_schema.md.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **CONPOT - Event Schema** within the Distributed Honeypot Benchmark Framework.
