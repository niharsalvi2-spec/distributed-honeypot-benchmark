...
## Overview
Audit specification for cowrie analyzing event_schema.md.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **COWRIE - Event Schema** within the Distributed Honeypot Benchmark Framework.
