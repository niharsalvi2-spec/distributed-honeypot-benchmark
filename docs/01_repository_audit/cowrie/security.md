...
## Overview
Audit specification for cowrie analyzing security.md.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **COWRIE - Security** within the Distributed Honeypot Benchmark Framework.
