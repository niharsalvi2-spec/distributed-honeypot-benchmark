...
## Overview
Audit specification for cowrie analyzing architecture.md.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **COWRIE - Architecture** within the Distributed Honeypot Benchmark Framework.
