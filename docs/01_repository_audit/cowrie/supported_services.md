# COWRIE - Supported Services
> **Status:** `WORKING` | **Suite:** Distributed Honeypot Benchmark Framework (Team Gamergenix, PCCOE)

## Overview
Audit specification for cowrie analyzing supported_services.md.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **COWRIE - Supported Services** within the Distributed Honeypot Benchmark Framework.
