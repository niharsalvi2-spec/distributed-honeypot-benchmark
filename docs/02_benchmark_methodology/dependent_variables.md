...
## Overview
Measured outputs: Precision, Recall, SRA, Throughput, End-to-End Latency, Inversion Rate.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **Dependent Variables** within the Distributed Honeypot Benchmark Framework.

## 2. Technical Specifications
- **Component ID:** dependent_variables
