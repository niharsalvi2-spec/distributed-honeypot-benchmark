...
## Overview
Linking actions across SSH, FTP, and HTTP decoys.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **Cross-Service Correlation** within the Distributed Honeypot Benchmark Framework.

## 2. Technical Specifications
- **Component ID:** cross_service_correlation
