...
## Overview
Audit specification for cowrie analyzing limitations.md.

## 1. Context & Scope
This document specifies operational standards, metrics, and parameters for **COWRIE - Limitations** within the Distributed Honeypot Benchmark Framework.
