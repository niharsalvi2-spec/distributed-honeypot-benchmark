# E02: Authentication Event Capture and Integrity

## Overview
Evaluates credential capture accuracy, brute-force session extraction, and password telemetry across SSH/Telnet.
...
```bash
python experiments/E02_authentication/runner.py
```
